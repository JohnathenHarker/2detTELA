...
lower_bound = 2
upper_bound = 21
# number of generated automata per automata type (in total: n*3 many automata)
n = 333
...
print('write result into ', path_evaluation +'/benchmarkE.csv')
## run evaluation
with open(path_evaluation+'/benchmarkE.csv', mode='w') as out_csv:
